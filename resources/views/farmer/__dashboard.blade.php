...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
								...
								<div class="flex-shrink-0 topbar d-flex align-items-stretch">
									...
									<div class="d-flex align-items-center me-lg-n2 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img class="rounded h-30px w-30px" src="assets/media/avatars/300-2.jpg" alt="" />
										</div>
						...
						<div class="timeline timeline-border-dashed">
							...
							<div class="timeline-item">
								...
								<div class="mb-10 timeline-content mt-n1">
									...
									<div class="overflow-auto pb-5">
										<!--begin::Record-->
										<div class="px-7 py-3 mb-5 rounded border border-gray-300 border-dashed d-flex align-items-center min-w-750px">
											<!--begin::Title-->
											<a href="apps/projects/project.html" class="text-gray-900 fs-5 text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
											<!--end::Title-->
											<!--begin::Label-->
											...
											<!--end::Label-->
											<!--begin::Users-->
											<div class="flex-nowrap symbol-group symbol-hover flex-grow-1 min-w-100px pe-2">
												<!--begin::User-->
										...
										<!--end::Record-->
										<!--begin::Record-->
										<div class="px-7 py-3 mb-0 rounded border border-gray-300 border-dashed d-flex align-items-center min-w-750px">
											<!--begin::Title-->
											<a href="apps/projects/project.html" class="text-gray-900 fs-5 text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
											<!--end::Title-->
											<!--begin::Label-->
							...
							<div class="timeline-item">
								...
								<div class="mb-10 timeline-content mt-n1">
									...
									<!--begin::Timeline details-->
									<div class="overflow-auto pb-5">
										<div class="p-5 rounded border border-gray-300 border-dashed d-flex align-items-center min-w-700px">
											<!--begin::Item-->
							...
							<div class="timeline-item">
								...
								<div class="mb-10 timeline-content mt-n1">
									...
									<!--begin::Timeline details-->
									<div class="overflow-auto pb-5">
										<div class="p-7 rounded border border-gray-300 border-dashed d-flex align-items-center min-w-700px">
											<!--begin::Item-->
							...
							<div class="timeline-item">
								...
								<div class="mb-10 timeline-content mt-n1">
									...
									<div class="overflow-auto pb-5">
										<!--begin::Notice-->
										<div class="flex-shrink-0 p-6 rounded border border-dashed notice d-flex bg-light-primary border-primary min-w-lg-600px">
											<!--begin::Icon-->
					...
					<div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
						...
						<div class="mb-10 d-flex justify-content-start">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-info fw-semibold mw-lg-400px text-start" data-kt-element="message-text">How likely are you to recommend our company to your friends and family ?</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-end">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-primary fw-semibold mw-lg-400px text-end" data-kt-element="message-text">Hey there, we’re just writing to let you know that you’ve been subscribed to a repository on GitHub.</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-start">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-info fw-semibold mw-lg-400px text-start" data-kt-element="message-text">Ok, Understood!</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-end">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-primary fw-semibold mw-lg-400px text-end" data-kt-element="message-text">You’ll receive notifications for all issues, pull requests!</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-start">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-info fw-semibold mw-lg-400px text-start" data-kt-element="message-text">You can unwatch this repository immediately by clicking here:
						...
						<div class="mb-10 d-flex justify-content-end">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-primary fw-semibold mw-lg-400px text-end" data-kt-element="message-text">Most purchased Business courses during this sale!</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-start">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-info fw-semibold mw-lg-400px text-start" data-kt-element="message-text">Company BBQ to celebrate the last quater achievements and goals. Food and drinks provided</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-end d-none" data-kt-element="template-out">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-primary fw-semibold mw-lg-400px text-end" data-kt-element="message-text"></div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-10 d-flex justify-content-start d-none" data-kt-element="template-in">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<!--end::User-->
								<!--begin::Text-->
								<div class="p-5 text-gray-900 rounded bg-light-info fw-semibold mw-lg-400px text-start" data-kt-element="message-text">Right before vacation season we have the next Big Deal for you.</div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
					...
					<div class="px-5 pt-0 modal-body pb-15 px-xl-20">
						...
						<div class="d-flex flex-column">
							...
							<div class="mx-auto nav-group nav-group-outline" data-kt-buttons="true">
								<button class="px-6 py-3 btn btn-color-gray-500 btn-active btn-active-secondary me-2 active" data-kt-plan="month">Monthly</button>
								<button class="px-6 py-3 btn btn-color-gray-500 btn-active btn-active-secondary" data-kt-plan="annual">Annual</button>
							</div>
							<!--end::Nav group-->
							<!--begin::Row-->
							<div class="mt-10 row">
							...
							<div class="flex-row-fluid py-lg-5 px-lg-15">
								...
								<form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
									...
									<div data-kt-stepper-element="content">
										<div class="w-100">
											<!--begin::Input group-->
											<div class="mb-7 d-flex flex-column fv-row">
												<!--begin::Label-->
		...
		<div class="modal fade" id="kt_modal_create_campaign" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="p-9 modal-dialog modal-fullscreen">
				<!--begin::Modal content-->
				<div class="modal-content modal-rounded">
					<!--begin::Modal header-->
					<div class="py-7 modal-header d-flex justify-content-between">
						<!--begin::Modal title-->
							...
							<form class="pb-10 mx-auto w-100 mw-600px pt-15" novalidate="novalidate" id="kt_modal_create_campaign_stepper_form">
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<h2 class="text-gray-900 fw-bold d-flex align-items-center">Setup Campaign Details
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											<!--begin::Title-->
											<h1 class="text-gray-900 fw-bold">Upload Files</h1>
											<!--end::Title-->
											<!--begin::Description-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											<!--begin::Title-->
											<h1 class="text-gray-900 fw-bold">Configure Audiences</h1>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="text-muted fw-semibold fs-4">If you need more info, please check
											<a href="#" class="link-primary">Campaign Guidelines</a></div>
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											<!--begin::Title-->
											<h1 class="text-gray-900 fw-bold">Budget Estimates</h1>
											<!--end::Title-->
											<!--begin::Description-->
											<div class="text-muted fw-semibold fs-4">If you need more info, please check
											<a href="#" class="link-primary">Campaign Guidelines</a></div>
										...
										<div class="mb-10 fv-row">
											...
											<div class="text-center d-flex flex-column">
												<div class="mb-7 d-flex align-items-start justify-content-center">
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-12 text-center">
											<!--begin::Title-->
											<h1 class="text-gray-900 fw-bold">Campaign Created!</h1>
											<!--end::Title-->
											<!--begin::Description-->
