    ...
    <div class="py-5 toolbar pb-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="flex-wrap container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="my-1 text-white d-flex fw-bold fs-3">Update Screening</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="p-0 card-body d-flex">
                            <div class="p-20 pb-40 flex-grow-1 card-rounded bgi-no-repeat">
                                <form method="post" action="{{ route('screening-owner.update', $screening->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        ...
                                        <div class="mb-5 form-group">
                                            ...
                                            <input name="date_time" value="{{$screening->date_time}}" required type="datetime-local" class="form-control">
