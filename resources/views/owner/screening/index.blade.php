                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="p-0 card-body d-flex">
                            <div class="p-20 pb-40 flex-grow-1 card-rounded bgi-no-repeat">
                                <a href="{{route('screening-owner.create')}}" type="button" class="mb-3 btn btn-success">
                                    Add Screening
                                  </a>
                                        ...
                                        <tbody>
                                            @foreach ($screening as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="{{route('sub_screening.owner', $item->id)}}">Sub Screening</a>
                                                    </td>
                                                    {{-- <td>
                                                        <a class="btn btn-info" href="{{route('screening-owner.edit', $item->id)}}">Edit</a>
                                                    </td> --}}
                                                    <td>
                                                        <form action="{{route('screening-owner.destroy', $item->id)}}" method="post">
                                                            @csrf
                                                            @method('DELETE')
