    ...
    <div class="py-5 toolbar pb-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="flex-wrap container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="my-1 text-white d-flex fw-bold fs-3">Edit Account {{$farmer->name}}</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                                ...
                                <form method="post" action="{{ route('farmer.update', $farmer->id) }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-5 form-group">
                                            ...
                                            <input name="name" value="{{$farmer->name}}" required type="text" class="form-control">

                                        </div>

                                        <div class="mb-5 form-group">
                                            <label>Email <span class="text-danger">*</span></label>
                                            <input name="email" value="{{$farmer->email}}" required type="email" class="form-control">
